...
import 'package:qrmenu/product/widget/customqrgenerator/custom_qr_generator.dart';
...
abstract class QrColor {
  ...
  static QrColorRadialGradient radialGradient(
          {required List<Color> colors, double radiusFraction = 1}) =>
      QrColorRadialGradient(colors: colors, radiusFraction: radiusFraction);

  static QrColorSweepGradient sweepGradient({required List<Color> colors}) =>
...
class QrColorUnspecified extends QrColor {
  ...
  @override
  bool operator ==(Object other) => other is QrColorUnspecified;
...
enum GradientOrientation { leftDiagonal, rightDiagonal, vertical, horizontal }
...
class QrColorLinearGradient extends QrColor {
  ...
  const QrColorLinearGradient(
      {required this.colors, required this.orientation});
  ...
  Paint createPaint(final double width, final double height) {
    ...
    return Paint()..shader = Gradient.linear(from, to, colors);
  }

  @override
  bool operator ==(Object other) =>
      other is QrColorLinearGradient &&
      other.colors == colors &&
...
class QrColorRadialGradient extends QrColor {
  ...
  const QrColorRadialGradient({required this.colors, this.radiusFraction = 1});

  @override
  Paint createPaint(final double width, final double height) => Paint()
    ..shader = Gradient.radial(Offset(width / 2, height / 2),
        min(width, height) * radiusFraction.coerceAtLeast(0), colors);

  @override
  bool operator ==(Object other) =>
      other is QrColorRadialGradient &&
      other.colors == colors &&
...
class QrColorSweepGradient extends QrColor {
  ...
  @override
  Paint createPaint(final double width, final double height) =>
      Paint()..shader = Gradient.sweep(Offset(width / 2, height / 2), colors);

  @override
  bool operator ==(Object other) =>
      other is QrColorSweepGradient && other.colors == colors;
